...
while(fightGuessAttempts > 0) {
  var fightGuess = prompt('Alright, last question! You\'ve been doing great so far! Here we go: It\'s been a few years, but Andrew used to do a lot of fighting back in the day! Can you guess one of the styles he trained  for MMA?').toLowerCase();
  fightGuessAttempts--;
